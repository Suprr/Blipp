...
public class LevelData : MonoBehaviour
{
    ...
    public static void LevelTwo()
    {
        ...
        boltPos[13][0] = -1;
        boltPos[13][1] = 1;
        boltPos[14] = new int[2];
        boltPos[14][0] = -1;
        boltPos[14][1] = -1;
        boltPos[15] = new int[2];
        boltPos[15][0] = 1;
        boltPos[15][1] = 0;
        boltPos[16] = new int[2];
        boltPos[16][0] = 0;
        boltPos[16][1] = 1;
        boltPos[17] = new int[2];
        boltPos[17][0] = 0;
        boltPos[17][1] = -1;
        boltPos[18] = new int[2];
        boltPos[18][0] = -1;
        boltPos[18][1] = -1;
        boltPos[19] = new int[2];
        boltPos[19][0] = 1;
        boltPos[19][1] = -1;

        cubeColors[0] = new Color[3][];
        cubeColors[0][0] = new Color[3];
        cubeColors[0][0][0] = colors[3];
        cubeColors[0][0][1] = colors[2];
        cubeColors[0][0][2] = colors[0];
        cubeColors[0][1] = new Color[3];
        cubeColors[0][1][0] = colors[0];
        cubeColors[0][1][1] = colors[1];
        cubeColors[0][1][2] = colors[2];
        cubeColors[0][2] = new Color[3];
        cubeColors[0][2][0] = colors[2];
        cubeColors[0][2][1] = colors[3];
        cubeColors[0][2][2] = colors[0];
        cubeColors[1] = new Color[3][];
        cubeColors[1][0] = new Color[3];
        cubeColors[1][0][0] = colors[1];
        ...
        cubeColors[1][0][2] = colors[2];
        cubeColors[1][1] = new Color[3];
        cubeColors[1][1][0] = colors[2];
        cubeColors[1][1][1] = colors[3];
        cubeColors[1][1][2] = colors[1];
        cubeColors[1][2] = new Color[3];
        cubeColors[1][2][0] = colors[3];
        cubeColors[1][2][1] = colors[1];
        cubeColors[1][2][2] = colors[2];
        cubeColors[2] = new Color[3][];
        cubeColors[2][0] = new Color[3];
        cubeColors[2][0][0] = colors[0];
        cubeColors[2][0][1] = colors[1];
        cubeColors[2][0][2] = colors[3];
        cubeColors[2][1] = new Color[3];
        cubeColors[2][1][0] = colors[3];
        cubeColors[2][1][1] = colors[0];
        cubeColors[2][1][2] = colors[1];
        cubeColors[2][2] = new Color[3];
        cubeColors[2][2][0] = colors[1];
        cubeColors[2][2][1] = colors[2];
        cubeColors[2][2][2] = colors[0];
    }
}
